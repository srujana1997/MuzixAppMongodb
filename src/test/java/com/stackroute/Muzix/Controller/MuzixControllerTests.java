...
//    Track track1 = new Track(1,"maatevinadhuga","sid sriram");
//    tracks.add(track1);
//    //when(muzixService.getTracksByName("maatevinadhuga")).thenReturn(tracks);
//    mockMvc.perform(get("/api/v1/trackByName?name=maatevinadhuga")
//            .contentType(MediaType.APPLICATION_JSON))
//            .andExpect(status().isOk());
//    //verify(muzixService, times(1)).getTracksByName("maatevinadhuga");
//    verifyNoMoreInteractions(muzixService);
//  }
